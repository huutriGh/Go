...
func main() {
	...
	fmt.Println(fmt.Sprintf("Your name is %s, and you are %d years old. Your favourite number is %.2f. You own a dog: %t.", user.UserName, user.Age, user.FavouriteNumber, user.OwnsADog))
